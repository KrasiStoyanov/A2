...
class DownloadFile {
    ...
    DownloadFile(Context context, String url, String pathWithoutFileName) {
        ...
        protected void onPostExecute(Boolean taskComplete) {
            if (taskComplete) {
                if (downloadedFile != null) {
                    ...
                    Timber.e(FileConstants.DOWNLOAD_FAILED);
                    // TODO: Notify the user that their download failed.
                }
            } else {
                Timber.e(FileConstants.DOWNLOAD_ERROR);
                // TODO: Notify the user that their download failed.
            }
        ...
        protected Boolean doInBackground(Void... voids) {
            try {
                ...
                if (responseCode != FileConstants.HTTP_OK) {
                    Timber.e(FileConstants.SERVER_RETURNED_HTTP_CODE + " " + responseCode);
                    // TODO: Notify the user that their download failed.
                }
                ...
                if (checkForSDCard.canWriteOnSDCard()) {
                    if (checkForSDCard.isSDCardPresent()) {
                        ...
                        Timber.e(FileConstants.NO_SD_CARD_FOUND);
                    ...
                    if (!apkStorage.exists()) {
                        apkStorage.mkdirs();
                        Timber.e(FileConstants.DIRECTORY_CREATED);
                    ...
                    if (!outputFile.exists()) {
                        ...
                        Timber.e(FileConstants.FILE_CREATED);
                    }
                ...
                Timber.e(FileConstants.DOWNLOAD_ERROR + " " + e.getMessage());
                // TODO: Notify the user that their download failed.
