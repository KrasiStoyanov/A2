...
import a2.mobile.mobileapp.handlers.FingerprintHandler;
import a2.mobile.mobileapp.handlers.PasscodeHandler;
...
public class LogInAdapter extends RecyclerView.Adapter<LogInAdapter.ViewHolder> {
    ...
    public LogInAdapter(Context context, List<AuthenticationOption> authenticationOptions) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        rootView.setOnClickListener(view -> {
            ...
            buttonRadius.setColor(view.getResources().getColor(R.color.snow_dark));
